...
###################################################
### code chunk number 2: loadImageSeq
###################################################
dir <- "images"
...
###################################################
### code chunk number 4: makeBackground
###################################################
## Detect background
...
###################################################
### code chunk number 5: plotBackground (eval = FALSE)
###################################################
## plot(stillBack)


###################################################
### code chunk number 6: BackgroundNoise
###################################################
...
###################################################
### code chunk number 7: substrBackground
###################################################
...
###################################################
### code chunk number 8: identifyParticles
###################################################
...
###################################################
### code chunk number 9: plotpartIden (eval = FALSE)
###################################################
## plot(partIden,frame=10)


###################################################
### code chunk number 10: trackParticlesHidden
###################################################
records <- trackParticles(partIden,L=60,R=3)


###################################################
### code chunk number 11: trackParticles (eval = FALSE)
###################################################
...
###################################################
### code chunk number 12: SummaryParticles
###################################################
summary(records, incThres=1)


###################################################
### code chunk number 13: records2
###################################################
# population count
...
###################################################
### code chunk number 15: plotRecords (eval = FALSE)
###################################################
...
###################################################
### code chunk number 16: noise (eval = FALSE)
###################################################
## dir.create("images")
## traj <- simulTrajec(path="images",
...
###################################################
### code chunk number 17: tmp1 (eval = FALSE)
###################################################
## mId <- manuallySelect(particles=partIden,frame=10)


###################################################
### code chunk number 18: createTraining (eval = FALSE)
###################################################
...
###################################################
### code chunk number 19: testTraining (eval = FALSE)
###################################################
## finalNN <- testNN(dat=mId,repetitions=10,maxH=4,prop=c(6,2,2))


###################################################
### code chunk number 20: loadNN
###################################################
load('nnVignetteSimul.RData')


###################################################
### code chunk number 21: outputnn
###################################################
finalNN
summary(finalNN)
...
###################################################
### code chunk number 22: trackParticlesNN (eval = FALSE)
###################################################
...
###################################################
### code chunk number 23: batchSetup
###################################################
...
###################################################
### code chunk number 24: recordsAtt
###################################################
  attributes(records)$settings 


###################################################
### code chunk number 25: batch
###################################################
setwd(wd)
batchpath <- "./batchTest"
...
###################################################
### code chunk number 26: batchshow
###################################################
results


###################################################
### code chunk number 27: batch2 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 28: merge (eval = FALSE)
###################################################
## dir.create("images")
## set.seed(100)
...
###################################################
### code chunk number 29: libav (eval = FALSE)
###################################################
## # sudo apt-get update
...
###################################################
### code chunk number 30: libavMac (eval = FALSE)
###################################################
...
###################################################
### code chunk number 31: createImageSeq (eval = FALSE)
###################################################
